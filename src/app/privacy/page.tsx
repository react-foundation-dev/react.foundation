        ...
        <div className="rounded-3xl border border-border/10 bg-muted/60 p-8 sm:p-12">
          ...
          <div className="prose prose-invert mt-8 max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="mt-6 text-xl font-semibold text-foreground">2.1 Personal Information</h3>
              <p className="mt-4 text-foreground/80">
              ...
              <h3 className="mt-6 text-xl font-semibold text-foreground">2.2 Local Storage</h3>
              <p className="mt-4 text-foreground/80">
              ...
              <h3 className="mt-6 text-xl font-semibold text-foreground">2.3 Session Data</h3>
              <p className="mt-4 text-foreground/80">
            ...
            <section className="mb-8">
              ...
              <h3 className="mt-6 text-xl font-semibold text-foreground">5.1 Authentication</h3>
              <p className="mt-4 text-foreground/80">
              ...
              <h3 className="mt-6 text-xl font-semibold text-foreground">5.2 E-commerce</h3>
              <p className="mt-4 text-foreground/80">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-foreground">6. Tracking and Analytics</h2>
              <p className="mt-4 text-foreground/80">
